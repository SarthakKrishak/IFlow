-- Additive-only migration: multi-assign + @mention notifications.
-- Creates two NEW tables. No ALTER/DROP of any existing table or column,
-- so this is safe to apply on the live database used by the team.
